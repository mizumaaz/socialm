/*
  # Add story views table for cross-device story tracking
  ...
  2. Security
    ...
    - Add policies for users to manage their own story views

  3. Indexes
    - Add indexes for better performance on story views
